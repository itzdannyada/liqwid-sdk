...
const LiqwidSDK = ({ 
  ...
  // Fetch UTXOs from Blockfrost API
  ...
  // Fetch yield data from Liqwid API
  ...
  // Fetch markets data from Liqwid API
    ...
    >
      {showHeader && (
        <div className="widget-header">
          <a href="https://liqwid.finance" target="_blank" rel="noopener noreferrer">
